      ...
      <div className={`relative bg-gray-900 rounded-xl overflow-hidden ${hideVideo ? 'hidden' : ''}`} style={{ aspectRatio: "9/16", maxHeight: "500px" }}>
        ...
        {!isConnected && !isConnecting && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-900/80">
            ...
            <p className="text-xs text-gray-500">{window.__t('auto_341', window.__t('auto_341', '接続ボタンを押してストリーミング開始'))}</p>
            {sandbox && (
          ...
          <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-1">
              <button
                ...
                title=={window.__t('auto_307', window.__t('auto_307', 'そのまま話す (Enter)'))}
              >
                {isSpeaking ? (
