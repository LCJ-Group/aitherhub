...
WORKER_CLIP_CONCURRENT: int = int(os.getenv("WORKER_CLIP_CONCURRENT", "6"))  # V14.2: Increased 4→6 to reduce queue wait. Clip ffmpeg is mostly I/O-bound (download+upload). Env var override available.
